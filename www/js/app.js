...
//})
    ...
    .config(function ($stateProvider, $urlRouterProvider, VeriduProvider) {
        ...
        $stateProvider.state('app', {
            ...
            .state('app.veriduLogin', {
                url: '/veriduLogin',
                views: {'menuContent': {templateUrl: 'templates/veriduLogin.html', controller: 'AppCtrl'}}
            })
            ...
            .state('app.profile', {
                url: '/profile/2',
                views: {'menuContent': {templateUrl: 'templates/profile.html', controller: 'ProfileCtrl'}}
            })
            ...
            .state('app.playlists', {
                url: '/playlists',
                views: {'menuContent': {templateUrl: 'templates/playlists.html', controller: 'PlaylistsCtrl'}}
            })

            .state('app.popup', {
                url: '/popup',
                views: {'menuContent': {templateUrl: 'templates/popup.html', controller: 'NotificationController'}}
            })
            ...
            .state('app.exhibits', {
                url: '/exhibits',
                views: {menuContent: {templateUrl: 'templates/exhibits.html', controller: 'ExhibitListCtrl'}}
            })
            .state('app.exhibit', {
                url: '/exhibits/:exhibitId',
                views: {menuContent: {templateUrl: 'templates/exhibit.html', controller: 'ExhibitCtrl'}}
            })
            .state('app.about', {
                url: '/about',
                views: {menuContent: {templateUrl: 'templates/about.html', controller: 'AboutCtrl'}}
            })
